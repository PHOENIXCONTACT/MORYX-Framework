...
namespace Marvin.Products.Model
{
    ...
    /// </summary>
    public partial interface IWorkplanReferenceRepository : IRepository<WorkplanReference>
    {
		/// <summary>
        /// Get all WorkplanReferences from the database
        /// </summary>
		/// <returns>A collection of entities. The result may be empty but not null.</returns>
        ICollection<WorkplanReference> GetAll();
        /// <summary>
