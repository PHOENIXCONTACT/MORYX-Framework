...
namespace Marvin.Products.Model
{
    ...
    /// </summary>
    public partial interface IConnectorEntityRepository : IRepository<ConnectorEntity>
    {
		/// <summary>
        /// Get all ConnectorEntitys from the database
        /// </summary>
		/// <returns>A collection of entities. The result may be empty but not null.</returns>
        ICollection<ConnectorEntity> GetAll();
        /// <summary>
