...
namespace Marvin.Products.Model
{
    ...
    /// </summary>
    public partial interface IProductDocumentRepository : IRepository<ProductDocument>
    {
		/// <summary>
        /// Get all ProductDocuments from the database
        /// </summary>
        ...
        ICollection<ProductDocument> GetAll(bool deleted);
        /// <summary>
