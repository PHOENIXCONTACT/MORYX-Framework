...
namespace Marvin.Products.Model
{
    ...
    {
        private Marvin.Products.Model.Entities _context;
        private readonly IDictionary<Type, RepoBuilder> _repoBuilders;

        public EntityFrameworkUnitOfWork(Marvin.Products.Model.Entities context, IDictionary<Type, RepoBuilder> repoBuilders)
        {
            _context = context;
        ...
        public string ModelNamespace { get { return "Marvin.Products.Model";  } }
        ...
        public virtual T GetRepository<T>() where T : class, IRepository
        {
            ...
            T repo;
            if (type.Namespace == "Marvin.Products.Model") 
