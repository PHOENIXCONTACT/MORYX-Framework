...
{
    internal partial class ConnectorEntityRepository : EntityFrameworkRepository<ConnectorEntity>, IConnectorEntityRepository
    {
        public static IRepository Create(IUnitOfWork uow, DbContext context)
        {
            var instance = new ConnectorEntityRepository();
            instance.UnitOfWork = uow;
            instance.Context = context;
            instance.DbSet = context.Set<ConnectorEntity>();
            return instance;
        }

        public ICollection<ConnectorEntity> GetAll()
		{
			return DbSet.ToList();
		}
        public ConnectorEntity Create(long connectorId, int classification) 
        {
            var entity = Create();
