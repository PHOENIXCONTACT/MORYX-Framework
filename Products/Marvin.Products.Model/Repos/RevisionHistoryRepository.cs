...
{
    internal partial class RevisionHistoryRepository : EntityFrameworkRepository<RevisionHistory>, IRevisionHistoryRepository
    {
        public static IRepository Create(IUnitOfWork uow, DbContext context)
        {
            var instance = new RevisionHistoryRepository();
            instance.UnitOfWork = uow;
            instance.Context = context;
            instance.DbSet = context.Set<RevisionHistory>();
            return instance;
        }

        public ICollection<RevisionHistory> GetAll()
		{
			return DbSet.ToList();
		}
        public RevisionHistory Create(string comment) 
        {
            var entity = Create();
