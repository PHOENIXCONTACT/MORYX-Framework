...
{
    /// <summary>
    /// The public API of the Operation repository.
    /// </summary>
    public partial interface IOperationRepository : IRepository<Operation>
    {
		/// <summary>
        ...
        /// <summary>
        /// Get first Operation that matches the given parameter 
        /// or null if no match was found.
        /// </summary>
        /// <param name="name">Value the entity has to match</param>
        /// <returns>First matching Operation</returns>
