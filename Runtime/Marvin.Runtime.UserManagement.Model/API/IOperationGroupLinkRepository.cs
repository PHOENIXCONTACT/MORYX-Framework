...
{
    /// <summary>
    /// The public API of the OperationGroupLink repository.
    /// </summary>
    public partial interface IOperationGroupLinkRepository : IRepository<OperationGroupLink>
    {
		/// <summary>
        /// Get all OperationGroupLinks from the database
        /// </summary>
		/// <returns>A collection of entities. The result may be empty but not null.</returns>
        ICollection<OperationGroupLink> GetAll();
        /// <summary>
        /// Creates instance with all not nullable properties prefilled
        /// </summary>
        OperationGroupLink Create(OperationAccess accessType); 
    }
}
