...
{
    /// <summary>
    /// The public API of the LibraryAccess repository.
    /// </summary>
    public partial interface ILibraryAccessRepository : IRepository<LibraryAccess>
    {
		/// <summary>
        /// Get all LibraryAccesss from the database
        /// </summary>
		/// <returns>A collection of entities. The result may be empty but not null.</returns>
        ICollection<LibraryAccess> GetAll();
    }
}
