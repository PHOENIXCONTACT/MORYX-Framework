...
{
    internal partial class OperationRepository : EntityFrameworkRepository<Operation>, IOperationRepository
    {
        public static IRepository Create(IUnitOfWork uow, DbContext context)
        {
            var instance = new OperationRepository();
            instance.UnitOfWork = uow;
            instance.Context = context;
            instance.DbSet = context.Set<Operation>();
            return instance;
        }
        ...
        public virtual Operation GetByName(string name)
        {
