...
namespace Marvin.Runtime.UserManagement.Model
{
    ...
    /// </summary>
    [ModelFactory("Marvin.Runtime.UserManagement.Model")]
    public class EntityFrameworkUnitOfWorkFactory : IUnitOfWorkFactory, IParentFactory, IInitializable
    {
        ...
        {
            var context = new Marvin.Runtime.UserManagement.Model.UserManagementContainer(_connectionString, ContextMode.AllOn);
