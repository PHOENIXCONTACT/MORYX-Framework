...
{
    internal partial class OperationGroupLinkRepository : EntityFrameworkRepository<OperationGroupLink>, IOperationGroupLinkRepository
    {
        public static IRepository Create(IUnitOfWork uow, DbContext context)
        {
            var instance = new OperationGroupLinkRepository();
            instance.UnitOfWork = uow;
            instance.Context = context;
            instance.DbSet = context.Set<OperationGroupLink>();
            return instance;
        }

        public ICollection<OperationGroupLink> GetAll()
		{
			return DbSet.ToList();
		}
        public OperationGroupLink Create(OperationAccess accessType) 
        {
            var entity = Create();
