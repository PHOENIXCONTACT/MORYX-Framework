...
namespace Marvin.Runtime.UserManagement.Model
{
    ...
    public class InMemoryUnitOfWorkFactory : IUnitOfWorkFactory, IParentFactory, IInitializable
    {
        ...
        private static readonly Dictionary<Type, RepoBuilder> RepoBuilders = new Dictionary<Type, RepoBuilder>
        {
            ...
            { typeof(IRepository<Application>), ApplicationRepository.Create },
            { typeof(ILibraryAccessRepository), LibraryAccessRepository.Create },
            { typeof(IRepository<LibraryAccess>), LibraryAccessRepository.Create },
            { typeof(IApplicationAccessRepository), ApplicationAccessRepository.Create },
            { typeof(IRepository<ApplicationAccess>), ApplicationAccessRepository.Create },
            { typeof(IOperationGroupRepository), OperationGroupRepository.Create },
            { typeof(IRepository<OperationGroup>), OperationGroupRepository.Create },
            { typeof(IOperationRepository), OperationRepository.Create },
            { typeof(IRepository<Operation>), OperationRepository.Create },
            { typeof(IOperationGroupLinkRepository), OperationGroupLinkRepository.Create },
            { typeof(IRepository<OperationGroupLink>), OperationGroupLinkRepository.Create },
         };
        ...
        private static string BuildConnectionString(IDatabaseConfig databaseConfig)
        {
            ...
            {
                Metadata = "res://*/Marvin.Runtime.UserManagement.Model.Model.UserManagement.csdl|" +
                           "res://*/Marvin.Runtime.UserManagement.Model.Model.UserManagement.ssdl|" +
                           "res://*/Marvin.Runtime.UserManagement.Model.Model.UserManagement.msl",
            };
        ...
        internal IUnitOfWork Create(Marvin.Runtime.UserManagement.Model.UserManagementContainer context) 
        {
            if (context == null)
        ...
        /// <returns>Created unit of work.</returns>
        internal IUnitOfWork CreateMerged(Marvin.Runtime.UserManagement.Model.UserManagementContainer context, IUnitOfWork other) 
        {
            if (context == null)
                throw new InvalidOperationException("Context has not been initialized.");
        ...
        public IUnitOfWork Create()
        {
            ...
            var context = new Marvin.Runtime.UserManagement.Model.UserManagementContainer(connection, ContextMode.AllOn);
        ...
        public IUnitOfWork Create(ContextMode mode)
        {
            ...
            var context = new Marvin.Runtime.UserManagement.Model.UserManagementContainer(connection, mode);
        ...
        {
            var context = new Marvin.Runtime.UserManagement.Model.UserManagementContainer(_connectionString, mode);
            other.Mode = mode;
