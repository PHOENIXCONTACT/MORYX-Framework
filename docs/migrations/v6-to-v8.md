...
- MORYX now solely relies on the default Aspn.Net way of adding localization to the application. For a very concise tutorial take a look in the [documentation](https://git-ctvc.europe.phoenixcontact.com/moryx/Home/-/blob/dev/tutorials/add-language-support.md)
