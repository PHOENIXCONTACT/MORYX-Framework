...
There are two existing Workplans both of which are currently opened in a session (as is the result of [test case 3](03-open-an-existing-workplan.md) executed twice).
