# Test Case 6 - Abort the creation of a new step

## Expected preconditions

There is an existing Workplan that is currently opened in the Workplan Editor (as is the result of [test case 3](03-open-an-existing-workplan.md)).
