...
Make sure you are logged in using an administrator account and have navigated to the roles page. There should also be an existing role besides the SuperAdmin role (as is the result of [test case 4](04_add_role.md)) as well as an existing permission (as is the result of [test case 2](02_add_permission.md)).
