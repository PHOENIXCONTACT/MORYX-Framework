...
Make sure you are logged in using an administrator account. There should be an existing user in addition to the default admin user (as is the result of [test case 10](10_register.md)).
