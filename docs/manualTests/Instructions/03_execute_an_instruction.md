...
Set the first assembly cell to 'Manual Mode' in the ResourceManagement. Set the success rate in the first Test resource in the Resource Management to 0%. **Create** and **Start** an Order in the Ordermanagement with two parts. Switch to the Instructions Module.
