# Test Case 8 - Show recipes of an operation
...
| Click on the **arrow back** tile in the navigation bar on the left side | The application routes back to the orders overview | All expansion panels are closed |
