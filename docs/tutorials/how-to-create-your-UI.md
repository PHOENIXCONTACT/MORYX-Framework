...
The second step highly depends on your own preferences, [here](how-to-add-an-angular-application-to-your-UI.md) you can get an example on how to continue adding a single page application as the content of your UI with Angular.
