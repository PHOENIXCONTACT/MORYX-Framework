...
MORYX brings out of the box extensions on the `DbContext` to provide the [UnitOfWork Repository Pattern](/docs/articles/framework/DataModel/unitof-work-pattern.md).
