...
Also have a look at the [repository proxy builder](repository-proxy-builder.md) for more information on how the code generation works.
...
For a complete example please read the [CodeFirst tutorial](/docs/tutorials/data-model/code-first.md).
