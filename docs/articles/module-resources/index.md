...
So [accessing a resource](resource-management.md) is done in an abstract and general way.
...
Look [here](resource-type-tree.md) to read what's about with resource types.

## Resource object graph

Look [here](resource-object-graph.md) if you want to know more about how resources are organized.

## Resource relation

Look [here](resource-relations.md) to dive deeper into resource relations.
