...
This article describes different branches of the [Resource type tree](../resource-type-tree.md). 
...
Similarly the [Driver resource](driver-resource.md) creates a branch for resources that represent hardware devices with their communication.
