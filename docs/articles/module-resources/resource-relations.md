...
After the [resource manager](resource-management.md) instantiated a resource it ﬁlters all reference properties using reﬂection.
...
Resource relations are stored in a separate table with their role and name (if any)
