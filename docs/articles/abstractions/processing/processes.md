...
A [Process](/src/Moryx.AbstractionLayer/Processes/IProcess.cs) will be created to produce one instance. Therefore it consists of a series of Activities from a defined workplan. It is managed by the ProcessController.
