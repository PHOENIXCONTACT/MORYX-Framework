...
* **Requirement 5:** Integrate with [Orders](../module-orders/index.md) where links have orders references.
* **Requirement 6:** Integrate with [Products](../module-products/index.md) for product/material reference links.
