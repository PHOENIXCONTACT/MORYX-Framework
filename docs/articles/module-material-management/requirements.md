...
**Status:** Proposed\
**Persona:** Operator, Application Engineer\
**Goal:** Find material containers by unique identifiers such as container identity, order, etc.

###### System Behavior
**Requirement 1:** Support inputs for container IDs (e.g. QR codes, Barcode) backed by [Identities](../abstractions/index.md#identity).\
...
**Requirement 6:** Operator link integrates with [Operators](missing-docs).\
...
###### System Behavior
**Requirement 1:** Users can edit metadata and links and linked details.\
...
###### System Behavior
**Requirement 1:** Persist all link lifecycle events, metadata changes, acknowledgments, and lineage operations with timestamps and user IDs.\
...
**Requirement 7:** Integrate with [Operators](missing-docs) for operator links.\
