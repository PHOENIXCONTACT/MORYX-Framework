...
namespace Moryx.Resources.Management
{
    ...
    internal interface IResourceLinker
    {
        ...
        /// </summary>
        Task<IReadOnlyList<Resource>> SaveRoots(IUnitOfWork uow, IReadOnlyList<Resource> instances);
        ...
        Task<IReadOnlyList<Resource>> SaveReferences(IUnitOfWork uow, Resource instance, ResourceEntity entity, Dictionary<Resource, ResourceEntity> partsDict = null);

        /// <summary>
        /// Save changes to a single collection
        /// </summary>
        /// <returns>Found new instances</returns>
        Task<IReadOnlyList<Resource>> SaveSingleCollection(IUnitOfWork uow, Resource instance, PropertyInfo property);
