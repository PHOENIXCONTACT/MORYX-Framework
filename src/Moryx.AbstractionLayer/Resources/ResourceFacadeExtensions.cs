...
public static class ResourceFacadeExtensions
{
    ...
    extension(IResourceManagement facade)
    {
        /// <summary>
        ...
        /// </remarks>
        public TResult ReadUnsafe<TResult>(IResource proxy, Func<Resource, TResult> accessor)
        {
        ...
        /// Use with extreme caution. Do not keep the instance in memory for later usage.
        /// </remarks>
        public Task ModifyUnsafeAsync(IResource proxy, Func<Resource, Task<bool>> modifier,
        ...
        /// Use with extreme caution. Do not keep the instance in memory for later usage.
        /// </remarks>
        public Task ModifyUnsafeAsync<TContext>(IResource proxy, Func<Resource, TContext, Task<bool>> modifier,
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests. The default value is None.</param>
        public Task<long> CreateUnsafeAsync<TResource>(Func<TResource, Task> initializer,
            CancellationToken cancellationToken = default)
