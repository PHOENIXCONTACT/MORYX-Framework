...
import { WorkerSupportService } from '../api/services';
...
export class InstructionService {
  ...
  public subscribeToStream() {
    ...
    this.eventSource = new EventSource(this.workerSupportService.rootUrl + '/api/moryx/instructions/stream', { withCredentials: !environment.production });
