        ...
        >
          <TableCell padding="none" width={48}>
            <IconButton
              ...
              <SvgIcon>
                <path d={this.state.open ? mdiChevronUp : mdiChevronDown}/>
              </SvgIcon>
            </IconButton>
          </TableCell>
            ...
            <Collapse in={this.state.open} unmountOnExit={true}>
              <Container disableGutters={true}>
                <Grid container={true} direction="row" rowSpacing={0.5} sx={{paddingBottom: 1}}>
                  ...
                  <Grid container={true}>
                    <Grid size={2}><Typography variant="body2" sx={{fontWeight: "bold"}}>Message</Typography></Grid>
                    <Grid size={10}> <Typography variant="body2" sx={{fontFamily: "Monospace"}}>{this.props.message.exception?.message}</Typography></Grid>
                  </Grid>
                  <Grid container={true}>
                    <Grid size={2}>
                  ...
                  </Grid>
                  {
                    this.props.message.exception?.innerException != null &&
                    <Grid container={true}>
                      <Grid size={12}>{NotificationRow.preRenderInnerException(this.props.message.exception?.innerException)}</Grid>
                    </Grid>
                  }
                </Grid>
              </Container>
  ...
  private static preRenderInnerException(exception: SerializableException): React.ReactNode {
    return (
      <Grid container={true} sx={{paddingLeft: 1, paddingRight: 0}} rowSpacing={0.5}>
        ...
        <Grid container={true}>
          <Grid size={2}><Typography variant="body2" sx={{fontWeight: "bold"}}>Message</Typography></Grid>
          <Grid size={10}> <Typography variant="body2" sx={{fontFamily: "Monospace"}}>{exception.message}</Typography></Grid>
        </Grid>
