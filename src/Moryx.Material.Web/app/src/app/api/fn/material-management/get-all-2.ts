...
export function getAll_2(http: HttpClient, rootUrl: string, params?: GetAll_2$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<MaterialContainerModel>>> {
...
getAll_2.PATH = '/api/moryx/materials/containers';
