...
import { getAll_3 } from '../fn/media-server/get-all-3';
import { GetAll_3$Params } from '../fn/media-server/get-all-3';
...
export class MediaServerService extends BaseService {
  ...
  /** Path part for operation `getAll_3()` */
  static readonly GetAll_3Path = '/api/moryx/media';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getAll_3()` instead.
   *
   * This method doesn't expect any request body.
   */
  getAll_3$Response(params?: GetAll_3$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ContentDescriptorModel>>> {
    const obs = getAll_3(this.http, this.rootUrl, params, context);
    return obs;
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getAll_3$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getAll_3(params?: GetAll_3$Params, context?: HttpContext): Observable<Array<ContentDescriptorModel>> {
    const resp = this.getAll_3$Response(params, context);
    return resp.pipe(
