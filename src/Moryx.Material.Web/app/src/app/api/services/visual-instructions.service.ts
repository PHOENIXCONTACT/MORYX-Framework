...
import { getAll_7 } from '../fn/visual-instructions/get-all-7';
import { GetAll_7$Params } from '../fn/visual-instructions/get-all-7';
...
export class VisualInstructionsService extends BaseService {
  ...
  /** Path part for operation `getAll_7()` */
  static readonly GetAll_7Path = '/api/moryx/instructions/{identifier}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getAll_7()` instead.
   *
   * This method doesn't expect any request body.
   */
  getAll_7$Response(params: GetAll_7$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<InstructionModel>>> {
    const obs = getAll_7(this.http, this.rootUrl, params, context);
    return obs;
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getAll_7$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getAll_7(params: GetAll_7$Params, context?: HttpContext): Observable<Array<InstructionModel>> {
    const resp = this.getAll_7$Response(params, context);
    return resp.pipe(
      map((r: StrictHttpResponse<Array<InstructionModel>>): Array<InstructionModel> => r.body)
    );
  }
