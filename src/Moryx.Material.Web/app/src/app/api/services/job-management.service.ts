...
export class JobManagementService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  getAll_1$Response(params?: GetAll_1$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<JobModel>>> {
    const obs = getAll_1(this.http, this.rootUrl, params, context);
    return obs;
  }
   ...
   * This method doesn't expect any request body.
   */
  getAll_1(params?: GetAll_1$Params, context?: HttpContext): Observable<Array<JobModel>> {
    const resp = this.getAll_1$Response(params, context);
    return resp.pipe(
