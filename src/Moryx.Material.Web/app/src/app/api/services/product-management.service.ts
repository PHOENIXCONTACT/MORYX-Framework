...
import { getTypes_1 } from '../fn/product-management/get-types-1';
import { GetTypes_1$Params } from '../fn/product-management/get-types-1';
...
export class ProductManagementService extends BaseService {
  ...
  static readonly GetTypes_1Path = '/api/moryx/products/types/query';
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  getTypes_1$Response(params?: GetTypes_1$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ProductModel>>> {
    const obs = getTypes_1(this.http, this.rootUrl, params, context);
    return obs;
  }
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  getTypes_1(params?: GetTypes_1$Params, context?: HttpContext): Observable<Array<ProductModel>> {
    const resp = this.getTypes_1$Response(params, context);
    return resp.pipe(
      map((r: StrictHttpResponse<Array<ProductModel>>): Array<ProductModel> => r.body)
    );
  }
