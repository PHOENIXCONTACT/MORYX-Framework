...
export function getOperatorsByResource(http: HttpClient, rootUrl: string, params: GetOperatorsByResource$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<MoryxOperatorsEndpointsExtendedOperatorModel>>> {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<Array<MoryxOperatorsEndpointsExtendedOperatorModel>>;
    })
  );
}
