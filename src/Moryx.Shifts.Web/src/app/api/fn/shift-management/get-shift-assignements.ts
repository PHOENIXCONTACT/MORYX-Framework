...
export function getShiftAssignements(http: HttpClient, rootUrl: string, params?: GetShiftAssignements$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<MoryxShiftsEndpointsShiftAssignementModel>>> {
