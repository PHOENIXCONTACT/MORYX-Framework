    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .Index(t => new { t.Identifier, t.Revision }, name: "Identifier_Revision_Index")
                .Index(t => t.Identifier, name: "Identifier")
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("products.WorkplanEntity", t => t.WorkplanId)
                .ForeignKey("products.ProductEntity", t => t.ProductId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropIndex("products.ProductEntity", "Identifier");
            DropIndex("products.ProductEntity", "Identifier_Revision_Index");
