...
export function getRunningProcessesOfJob(http: HttpClient, rootUrl: string, params?: GetRunningProcessesOfJob$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<JobProcessModel>>> {
