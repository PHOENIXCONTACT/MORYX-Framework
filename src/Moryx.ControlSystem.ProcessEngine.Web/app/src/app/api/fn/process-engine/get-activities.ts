...
export function getActivities(http: HttpClient, rootUrl: string, params: GetActivities$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ProcessActivityModel>>> {
