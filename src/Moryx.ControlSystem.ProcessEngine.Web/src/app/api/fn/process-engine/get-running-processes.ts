...
export function getRunningProcesses(http: HttpClient, rootUrl: string, params?: GetRunningProcesses$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<JobProcessModel>>> {
