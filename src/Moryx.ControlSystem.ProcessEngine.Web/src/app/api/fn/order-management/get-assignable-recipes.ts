...
export function getAssignableRecipes(http: HttpClient, rootUrl: string, params?: GetAssignableRecipes$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<MoryxOrdersEndpointsOperationRecipeModel>>> {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<Array<MoryxOrdersEndpointsOperationRecipeModel>>;
    })
  );
}
