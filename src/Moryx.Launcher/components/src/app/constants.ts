export class Constants {
    ...
    public static readonly WebComponentNames = {
        DropdownMenu: "moryx-dropdown-menu",
        DropdownItem: "moryx-dropdown-item",
        DropdownContainer: "moryx-dropdown-container",
        DropdownSubItem: "moryx-dropdown-subitem",
