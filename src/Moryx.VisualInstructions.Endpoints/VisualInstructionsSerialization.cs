...
internal class VisualInstructionsSerialization : PossibleValuesSerialization
{
    /// <summary>
    ...
    public VisualInstructionsSerialization(IContainer container, IServiceProvider serviceProvider) : base(container, serviceProvider, new ValueProviderExecutor(new ValueProviderExecutorSettings()))
    {
    }
