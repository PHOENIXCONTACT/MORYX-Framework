...
namespace Moryx.Orders.Assignment
{
    ...
    public interface IOperationValidation : IAsyncConfiguredPlugin<OperationValidationConfig>
    {
        ...
        /// </summary>
        Task<bool> ValidateAsync(Operation operation, IOperationLogger operationLogger, CancellationToken cancellationToken = default);

        /// <summary>
        /// Validates the given creation context
        /// </summary>
        Task<bool> ValidateCreationContextAsync(OrderCreationContext orderContext, CancellationToken cancellationToken = default);
    }
}
