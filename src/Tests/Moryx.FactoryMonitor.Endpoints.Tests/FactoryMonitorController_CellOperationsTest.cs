...
namespace Moryx.FactoryMonitor.Endpoints.Tests
{
    ...
    public class FactoryMonitorController_CellOperationsTest : BaseTest
    {
        ...
        [Test]
        public void CellSettings_Update_Should_Return_200_OK()
        {
            // Arange
            ...
            //Act
            var endPointResult = _factoryMonitor.CellSettings(id, newCellSettings);
        ...
        [Test]
        public void MoveCell_Shouldwork_For_CorrectId()
        {
            // Arange
            ...
            //Act
            var endPointResult = _factoryMonitor.MoveCell(newLocation);
