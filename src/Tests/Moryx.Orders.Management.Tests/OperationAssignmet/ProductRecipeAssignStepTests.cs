...
namespace Moryx.Orders.Management.Tests
{
    ...
    public class ProductRecipeAssignStepTests
    {
        ...
        public async Task AssignProductAndRecipe()
        {
            ...
            _productManagementMock.Setup(m => m.GetRecipes(It.IsAny<IProductType>(), RecipeClassification.Default)).Returns(new[] { new DummyRecipe() });
        ...
        public async Task RestoreProductAndRecipe()
        {
            ...
            _operationDataMock.Setup(o => o.AssignProduct(It.IsAny<IProductType>())).Callback((IProductType productType) =>
            {
                product = productType;
