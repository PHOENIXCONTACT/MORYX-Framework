...
/// <summary>
/// Lineage event recorded when a container is linked to a product type.
/// </summary>
[DataContract]
public class ProductTypeLinkLineageEvent : LinkLineageEventBase
{
    /// <summary>
    /// Identity of the product type that was linked.
    /// </summary>
    [DataMember]
