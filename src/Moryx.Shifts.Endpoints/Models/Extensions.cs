...
internal static class Extensions
{
    ...
    public static ShiftAssignementModel ToModel(this ShiftAssignement assignement) =>
        ...
        {
            Id = assignement.Id,
            ShiftId = assignement.Shift.Id,
            ResourceId = assignement.Resource.Id,
            OperatorIdentifier = assignement.Operator.Identifier,
            Note = assignement.Note,
            Priority = assignement.Priority,
            AssignedDays = assignement.AssignedDays
        };
