...
import { FactoryStateModel } from 'src/app/api/models/Moryx/FactoryMonitor/Endpoints/Model/factory-state-model';
...
import { VisualizableItemModel } from 'src/app/api/models/Moryx/FactoryMonitor/Endpoints/Models/visualizable-item-model';
