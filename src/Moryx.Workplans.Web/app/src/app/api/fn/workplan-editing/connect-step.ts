...
export interface ConnectStep$Params {
  sessionId: string;
  targetNodeId: number;
  targetIndex: number;
      body?: NodeConnector
...
export function connectStep(http: HttpClient, rootUrl: string, params: ConnectStep$Params, context?: HttpContext): Observable<StrictHttpResponse<WorkplanSessionModel>> {
  const rb = new RequestBuilder(rootUrl, connectStep.PATH, 'post');
  if (params) {
