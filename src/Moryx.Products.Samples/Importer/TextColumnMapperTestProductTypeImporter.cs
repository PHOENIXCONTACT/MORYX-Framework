...
namespace Moryx.Products.Samples.Importer;

public class TextColumnMapperTestProductTypeImporter :
    ProductImporterBase<
        TextColumnMapperTestProductTypeImporterConfig,
        TextColumnMapperTestProductTypeParameters>
{
    protected override Task<ProductImporterResult> ImportAsync(
        ProductImportContext context,
        TextColumnMapperTestProductTypeParameters parameters,
