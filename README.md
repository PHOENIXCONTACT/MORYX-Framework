<p align="center">
    ...
    <a href="https://codecov.io/gh/PHOENIXCONTACT/MORYX-Framework">
...
To contribute to the development of MORYX, ensure you have the following prerequisites installed:
...
|Component|Packages|
|:--------|:------|
|[MORYX](./docs/articles/framework/index.md)|[Moryx](./src/Moryx)<br>[Moryx.AspNetCore](./src/Moryx.AspNetCore)<br>[Moryx.AspNetCore.Mqtt](./src/Moryx.AspNetCore.Mqtt)<br>[Moryx.TestTools.UnitTest](./src/Moryx.TestTools.UnitTest)<br>[Moryx.TestTools.IntegrationTest](./src/Moryx.TestTools.IntegrationTest)|
|[MORYX AbstractionLayer](./docs/articles/abstractions/index.md)|[Moryx.AbstractionLayer](./src/Moryx.AbstractionLayer)<br>[Moryx.AbstractionLayer.TestTools](./src/Moryx.AbstractionLayer.TestTools)<br>[Moryx.AbstractionLayer.Resources.Mqtt.Endpoints](./src/Moryx.AbstractionLayer.Resources.Mqtt.Endpoints)<br>[Moryx.Factory](./src/Moryx.Factory)<br>[Moryx.Users](./src/Moryx.Users)|
|[MORYX Container](./docs/articles/framework/dependency-injection.md)|[Moryx.Container](./src/Moryx.Container)|
|[MORYX Runtime](./docs/articles/runtime/index.md)|[Moryx.Runtime](./src/Moryx.Runtime)<br>[Moryx.Runtime.Endpoints](./src/Moryx.Runtime.Endpoints)<br>[Moryx.Runtime.Kernel](./src/Moryx.Runtime.Kernel)<br>[Moryx.CommandCenter.Web](./src/Moryx.CommandCenter.Web)|
|[MORYX Model](./docs/articles/framework/DataModel/index.md)|[Moryx.Model](./src/Moryx.Model)<br>[Moryx.Model.InMemory](./src/Moryx.Model.InMemory)<br>[Moryx.Model.PostgreSQL](./src/Moryx.Model.PostgreSQL)<br>[Moryx.Model.SqlServer](./src/Moryx.Model.SqlServer)<br>[Moryx.Model.Sqlite](./src/Moryx.Model.Sqlite)|
|[MORYX Communication](./docs/articles/framework/binary-connection.md)|[Moryx.Communication.Serial](./src/Moryx.Communication.Serial)|
|Samples|[Moryx.Benchmarking](./src/Moryx.Benchmarking)<br>[Moryx.Products.Samples](./src/Moryx.Products.Samples)<br>[Moryx.Resources.Samples](./src/Moryx.Resources.Samples)<br>[Moryx.Resources.Benchmarking](./src/Moryx.Resources.Benchmarking)<br>[Moryx.Resources.BenchmarkSetup](./src/Moryx.Resources.BenchmarkSetup)<br>[Moryx.Workplans.Samples](./src/Moryx.Workplans.Samples)|
</details>
...
|[Module - Resources](./docs/articles/module-resources/index.md)|[Moryx.Resources.Management](./src/Moryx.Resources.Management)<br>[Moryx.Resources.Web](./src/Moryx.Resources.Web)<br>[Moryx.AbstractionLayer.Resources.Endpoints](./src/Moryx.AbstractionLayer.Resources.Endpoints)|
...
|[Module - Visual Instructions](./docs/articles/module-visual-instructions/index.md)|[Moryx.VisualInstructions](./src/Moryx.VisualInstructions)<br>[Moryx.VisualInstructions.Controller](./src/Moryx.VisualInstructions.Controller)<br>[Moryx.VisualInstructions.Endpoints](./src/Moryx.VisualInstructions.Endpoints)<br>[Moryx.VisualInstructions.Web](./src/Moryx.VisualInstructions.Web)<br>[Moryx.Resources.VisualInstructions](./src/Moryx.Resources.VisualInstructions)|
...
|[Access Management](./docs/articles/moryx-accessmanagement/index.md)|[Moryx.Identity](./src/Moryx.Identity)<br>[Moryx.Identity.AccessManagement](./src/Moryx.Identity.AccessManagement)|
|[Web - Factory Monitor](./docs/articles/module-factory-monitor/index.md)|[Moryx.FactoryMonitor.Endpoints](./src/Moryx.FactoryMonitor.Endpoints)<br>[Moryx.FactoryMonitor.Web](./src/Moryx.FactoryMonitor.Web)|
|[Web - Launcher](./docs/articles/launcher/index.md)|[Moryx.Launcher](./src/Moryx.Launcher)|
