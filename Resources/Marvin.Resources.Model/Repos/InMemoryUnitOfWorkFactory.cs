...
namespace Marvin.Resources.Model
{
    ...
    public class InMemoryUnitOfWorkFactory : IUnitOfWorkFactory, IParentFactory, IInitializable
    {
        ...
        {
            { typeof(IResourceEntityRepository), ResourceEntityRepository.Create },
            { typeof(IRepository<ResourceEntity>), ResourceEntityRepository.Create },
            { typeof(IResourceRelationRepository), ResourceRelationRepository.Create },
            { typeof(IRepository<ResourceRelation>), ResourceRelationRepository.Create },
         };
        ...
        internal IUnitOfWork Create(Marvin.Resources.Model.Entities context) 
        {
            if (context == null)
        ...
        /// <returns>Created unit of work.</returns>
        internal IUnitOfWork CreateMerged(Marvin.Resources.Model.Entities context, IUnitOfWork other) 
        {
            if (context == null)
                throw new InvalidOperationException("Context has not been initialized.");
        ...
        public IUnitOfWork Create()
        {
            ...
            var context = new Marvin.Resources.Model.Entities(connection, ContextMode.AllOn);
        ...
        public IUnitOfWork Create(ContextMode mode)
        {
            ...
            var context = new Marvin.Resources.Model.Entities(connection, mode);
        ...
        {
            var context = new Marvin.Resources.Model.Entities(_connectionString, mode);
            other.Mode = mode;
