...
namespace Marvin.TestTools.TestMerge.Model
{
    ...
    public class InMemoryUnitOfWorkFactory : IUnitOfWorkFactory, IParentFactory, IInitializable
    {
        ...
        public IUnitOfWork Create()
        {
            ...
            var context = new Marvin.TestTools.TestMerge.Model.Entities(connection, ContextMode.AllOn);
        ...
        public IUnitOfWork Create(ContextMode mode)
        {
            ...
            var context = new Marvin.TestTools.TestMerge.Model.Entities(connection, mode);
