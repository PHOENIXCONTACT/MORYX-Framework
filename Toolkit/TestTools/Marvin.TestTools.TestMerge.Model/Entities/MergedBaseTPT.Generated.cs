...
namespace Marvin.TestTools.TestMerge.Model
{
    ...
    /// <summary>
    /// There are no comments for Marvin.TestTools.TestMerge.Model.MergedBaseTPT in the schema.
    /// </summary>
    [System.Runtime.Serialization.DataContractAttribute(IsReference=true)]
    public partial class MergedBaseTPT : IEquatable<MergedBaseTPT>, IMergeParent, IModificationTrackedEntity    {
        /// <summary>
        /// Default constructor
        /// </summary>
        public MergedBaseTPT()
        {
        }
        ...
        /// <summary>
        /// There are no comments for CombinedBaseTPT in the schema.
        /// </summary>
        [System.Runtime.Serialization.DataMember]
        public virtual global::System.Nullable<int> CombinedBaseTPT
        {
            get
            {
                return _combinedBaseTPT;
            }
            set
            {
                if (_combinedBaseTPT != value)
                {
                    _combinedBaseTPT = value;
                    OnPropertyChanged("CombinedBaseTPT");
                }
            }
        }
        private global::System.Nullable<int> _combinedBaseTPT;
        ...
        {
            return Equals(other as MergedBaseTPT); 
        }
        ...
        /// Determines whether the specified object is equal to the current object.
        /// </summary>
        /// <param name="other">The MergedBaseTPT to compare with the current MergedBaseTPT.</param>
        /// <returns><c>true</c> if the specified MergedBaseTPT is equal to the current MergedBaseTPT; otherwise, <c>false</c>.</returns>
        public bool Equals(MergedBaseTPT other)
        {
        ...
        /// <summary>
        /// Compares two MergedBaseTPT objects.
        /// </summary>
        /// <param name="a">The first MergedBaseTPT to compare</param>
        /// <param name="b">The second MergedBaseTPT to compare</param>
        /// <returns><c>true</c> if the specified objects are equal; otherwise, <c>false</c>.</returns>
        public static bool operator ==(MergedBaseTPT  a, MergedBaseTPT  b)
        {
