...
{
    public partial interface ISimpleChildRepository 
    {
        /// <summary>
        /// Creates instance with all not nullable properties prefilled including merged properties
        /// </summary>
        SimpleChild Create(int test, Int32 number); 
        /// <summary>
        /// Creates instance with all not nullable properties prefilled including merged properties
        /// </summary>
        SimpleChild Create(int test, TopParent parent); 
        /// <summary>
        ...
        /// documentation.
        /// </summary>
        IEnumerable<SimpleChild> GetAllByUpdated(System.DateTime updated);
        /// <summary>
        /// Method inherited from the <see cref="ITopParentRepository"/>.
        /// For details have a look at <see cref="ITopParentRepository.GetByNumber"/>
        /// documentation.
        /// </summary>
        SimpleChild GetByNumber(System.Int32 number);
        /// <summary>
        /// Method inherited from the <see cref="ITopParentRepository"/>.
        /// For details have a look at <see cref="ITopParentRepository.GetCreatedAndUpdated"/>
        /// documentation.
        /// </summary>
        SimpleChild GetCreatedAndUpdated(System.DateTime created, System.DateTime updated);
        /// <summary>
        /// Method inherited from the <see cref="ITopParentRepository"/>.
        /// For details have a look at <see cref="ITopParentRepository.GetUpdatedAndNumber"/>
        /// documentation.
        /// </summary>
        IEnumerable<SimpleChild> GetUpdatedAndNumber(System.DateTime updated, System.Int32 number);
    }

    internal partial class SimpleChildRepository
    {
        public SimpleChild Create(int test, Int32 number) 
        {
            var entity = Create();
        ...
        public SimpleChild Create(int test, TopParent parent) 
        {
        ...
        public IEnumerable<SimpleChild> GetAllByUpdated(System.DateTime updated)
        {
            var result = ParentUow.GetRepository<ITopParentRepository>().GetAllByUpdated(updated);
            if (result == null || !result.Any())
				return new List<SimpleChild>();
            return result.Select(LoadByTopParent).Where(entity => entity != null);
        }
        public SimpleChild GetByNumber(System.Int32 number)
        {
        ...
        public SimpleChild GetCreatedAndUpdated(System.DateTime created, System.DateTime updated)
        {
        ...
        public IEnumerable<SimpleChild> GetUpdatedAndNumber(System.DateTime updated, System.Int32 number)
        {
