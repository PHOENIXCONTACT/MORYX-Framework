...
{
    public partial class EnhancedChild : IMergedEntity<TopParent>
    {
    	...
    	/// </summary>
        public static implicit operator TopParent(EnhancedChild mergedClass)
        {
		...
		/// Implicit type cast operator
    	/// </summary>
        public static explicit operator EnhancedChild(TopParent inheritedClass)
        {
            ...
            if (child == null)
                throw new InvalidCastException("Base class is not of type EnhancedChild");   
            return (EnhancedChild)child; 
        }    
    }
}
