...
{
    /// <summary>
    /// The public API of the MergedBaseTPH repository.
    /// </summary>
    public partial interface IMergedBaseTPHRepository : IRepository<MergedBaseTPH>
    {
		/// <summary>
        /// Get all MergedBaseTPHs from the database
        /// </summary>
        ...
        ICollection<MergedBaseTPH> GetAll(bool deleted);
        /// <summary>
        /// Get first MergedBaseTPH that matches the given parameter 
        /// or null if no match was found.
        /// </summary>
        /// <param name="temp">Value the entity has to match</param>
        /// <returns>First matching MergedBaseTPH</returns>
        MergedBaseTPH GetByTemp(global::System.Nullable<double> temp);
    }
}
