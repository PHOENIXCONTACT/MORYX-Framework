...
{
    /// <summary>
    /// The public API of the JsonTester repository.
    /// </summary>
    public partial interface IJsonTesterRepository : IRepository<JsonTester>
    {
		/// <summary>
        /// Get all JsonTesters from the database
        /// </summary>
        ...
        ICollection<JsonTester> GetAll(bool deleted);
        /// <summary>
        /// Creates instance with all not nullable properties prefilled
        /// </summary>
        JsonTester Create(string jsonData); 
    }
}
