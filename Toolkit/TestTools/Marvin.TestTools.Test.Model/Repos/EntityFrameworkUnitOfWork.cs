...
namespace Marvin.TestTools.Test.Model
{
    ...
    {
        private Marvin.TestTools.Test.Model.Entities _context;
        private readonly IDictionary<Type, RepoBuilder> _repoBuilders;

        public EntityFrameworkUnitOfWork(Marvin.TestTools.Test.Model.Entities context, IDictionary<Type, RepoBuilder> repoBuilders)
        {
            _context = context;
        ...
        public string ModelNamespace { get { return "Marvin.TestTools.Test.Model";  } }
        ...
        public virtual T GetRepository<T>() where T : class, IRepository
        {
            ...
            T repo;
            if (type.Namespace == "Marvin.TestTools.Test.Model") 
                repo = (T)_repoBuilders[typeof(T)](this, _context);
            else
                throw new InvalidOperationException("Context does not provide access to repositories of this type");
            return repo;
        }
