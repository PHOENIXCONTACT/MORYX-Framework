...
namespace Marvin.TestTools.Test.Model
{
	...
	/// </summary>
	internal class TestModelTriggerScript : IDatabaseScript
	{
		public string Name { get { return "TestModelTriggerScript"; } }
		...
		public string GetText()
		{
			...
			script.AppendLine(string.Format(triggerCommand, "TopParent"));
			script.AppendLine(string.Format(triggerCommand, "JsonTester"));
			script.AppendLine(string.Format(triggerCommand, "Inherited"));
