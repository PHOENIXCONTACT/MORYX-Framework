...
You managed to create the model "ModelTemplates" using one of Thomas self written developer tools. To get started
with your own database open any file explorer and navigate to the model directory referenced by this project.
There you will find a file named "ModelTemplates.edml". Open it with the devArt EntityDeveloper. You can now start
creating classes and connecting them with associations.

The output settings will allready be configured and all generated classes will be in the ModelTemplates
...
The files "ModelTemplates.edml", "ModelTemplates.edps" and "ModelTemplates.Diagram1.view" can be excluded from the project. They
