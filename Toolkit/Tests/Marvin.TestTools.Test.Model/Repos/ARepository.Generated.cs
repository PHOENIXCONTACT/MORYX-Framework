...
{
    internal partial class ARepository : EntityFrameworkRepository<A>, IARepository
    {
        public static IRepository Create(IUnitOfWork uow, DbContext context)
        {
            var instance = new ARepository();
            instance.UnitOfWork = uow;
            instance.Context = context;
            instance.DbSet = context.Set<A>();
            return instance;
        }

        public ICollection<A> GetAll()
		{
			return DbSet.ToList();
		}
