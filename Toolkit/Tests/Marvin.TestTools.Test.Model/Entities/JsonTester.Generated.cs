...
namespace Marvin.TestTools.Test.Model
{
    ...
    /// <summary>
    /// There are no comments for Marvin.TestTools.Test.Model.JsonTester in the schema.
    /// </summary>
    [System.Runtime.Serialization.DataContractAttribute(IsReference=true)]
    public partial class JsonTester : IEquatable<JsonTester>, IMergeParent, IModificationTrackedEntity    {
        /// <summary>
        /// Default constructor
        /// </summary>
        public JsonTester()
        ...
        {
            return Equals(other as JsonTester); 
        }
        ...
        /// Determines whether the specified object is equal to the current object.
        /// </summary>
        /// <param name="other">The JsonTester to compare with the current JsonTester.</param>
        /// <returns><c>true</c> if the specified JsonTester is equal to the current JsonTester; otherwise, <c>false</c>.</returns>
        public bool Equals(JsonTester other)
        {
        ...
        /// <summary>
        /// Compares two JsonTester objects.
        /// </summary>
        /// <param name="a">The first JsonTester to compare</param>
        /// <param name="b">The second JsonTester to compare</param>
        /// <returns><c>true</c> if the specified objects are equal; otherwise, <c>false</c>.</returns>
        public static bool operator ==(JsonTester  a, JsonTester  b)
        {
