...
{
    /// <summary>
    /// The public API of the BaseClass repository.
    /// </summary>
    public partial interface IBaseClassRepository : IRepository<BaseClass>
    {
		/// <summary>
        /// Get all BaseClasss from the database
        /// </summary>
        ...
        ICollection<BaseClass> GetAll(bool deleted);
    }
}
