...
namespace Marvin.TestTools.TestMerge.Model
{
    ...
    /// <summary>
    /// There are no comments for Marvin.TestTools.TestMerge.Model.TriggerTest in the schema.
    /// </summary>
    [System.Runtime.Serialization.DataContractAttribute(IsReference=true)]
    public partial class TriggerTest : IEquatable<TriggerTest>, IMergeParent, IModificationTrackedEntity    {
        /// <summary>
        /// Default constructor
        /// </summary>
        public TriggerTest()
        ...
        {
            return Equals(other as TriggerTest); 
        }
        ...
        /// Determines whether the specified object is equal to the current object.
        /// </summary>
        /// <param name="other">The TriggerTest to compare with the current TriggerTest.</param>
        /// <returns><c>true</c> if the specified TriggerTest is equal to the current TriggerTest; otherwise, <c>false</c>.</returns>
        public bool Equals(TriggerTest other)
        {
        ...
        /// <summary>
        /// Compares two TriggerTest objects.
        /// </summary>
        /// <param name="a">The first TriggerTest to compare</param>
        /// <param name="b">The second TriggerTest to compare</param>
        /// <returns><c>true</c> if the specified objects are equal; otherwise, <c>false</c>.</returns>
        public static bool operator ==(TriggerTest  a, TriggerTest  b)
        {
