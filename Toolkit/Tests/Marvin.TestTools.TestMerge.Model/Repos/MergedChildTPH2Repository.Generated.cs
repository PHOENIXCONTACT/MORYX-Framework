...
{
    internal partial class MergedChildTPH2Repository : InheritedEntityFrameworkRepository<MergedChildTPH2>, IMergedChildTPH2Repository
    {
        public static IRepository Create(IUnitOfWork uow, DbContext context, IUnitOfWork parentUow)
        {
            var instance = new MergedChildTPH2Repository();
            instance.UnitOfWork = uow;
            instance.Context = context;
            instance.ParentUow = parentUow;
            instance.DbSet = context.Set<MergedChildTPH2>();
            return instance;
        }

        public ICollection<MergedChildTPH2> GetAll(bool deleted)
		{
			return DbSet.Where(e => e.Deleted == null || deleted).ToList();
		}
        public virtual MergedChildTPH2 GetByTemp(global::System.Nullable<double> temp)
        {
		    return DbSet.FirstOrDefault(e => e.Temp == temp && e.Deleted == null);
        }

        public virtual MergedChildTPH2 GetByB(global::System.Nullable<int> b)
        {
		    return DbSet.FirstOrDefault(e => e.B == b && e.Deleted == null);
        }

        protected override void ExecuteRemove(MergedChildTPH2 entity, bool permanent)
        {
            if (permanent)
		...
		protected override void ExecuteRemoveRange(IEnumerable<MergedChildTPH2> entities, bool permanent)
		{
            if (permanent)
            {
