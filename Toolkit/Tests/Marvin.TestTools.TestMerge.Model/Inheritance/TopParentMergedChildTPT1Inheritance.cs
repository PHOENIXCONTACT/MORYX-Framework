...
{
    public partial class MergedChildTPT1 : IMergedEntity<TopParent>
    {
    	...
    	/// </summary>
        public static implicit operator TopParent(MergedChildTPT1 mergedClass)
        {
		...
		/// Implicit type cast operator
    	/// </summary>
        public static explicit operator MergedChildTPT1(TopParent inheritedClass)
        {
            ...
            if (child == null)
                throw new InvalidCastException("Base class is not of type MergedChildTPT1");   
            return (MergedChildTPT1)child; 
        }    
    }
}
